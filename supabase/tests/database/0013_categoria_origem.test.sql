...
select lives_ok(
  $$ select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Marcos Silva', '11988887777', null, null, null, 'Indicação') $$,
...
select lives_ok(
  $$ select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Legado', '11955554444', null, null, null, 'Passou na rua') $$,
...
select lives_ok(
  $$ select criar_agendamento_publico('11111111-1111-1111-1111-111111111111', 'a0000000-0000-0000-0000-000000000001', 'b0000000-0000-0000-0000-000000000001', current_date + 1, '09:00', 'Cliente Público', '11933332222', null, null, 'Redes sociais') $$,
