...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Um', '11900000001', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Um', '11900000001', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000003');
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Verde', '11900000002', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
select set_config('request.jwt.claim.sub', 'aaaaaaaa-0000-0000-0000-000000000001', true);
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Amarelo', '11900000003', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
select set_config('request.jwt.claim.sub', 'aaaaaaaa-0000-0000-0000-000000000001', true);
insert into atendimentos (barbearia_id, membro_id, cliente_id, servico_id, preco, data) values
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Vermelho', '11900000004', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
select set_config('request.jwt.claim.sub', 'aaaaaaaa-0000-0000-0000-000000000001', true);
insert into atendimentos (barbearia_id, membro_id, cliente_id, servico_id, preco, data) values
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente PrazoCurto', '11900000005', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente SemVisita', '11900000006', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Do Marcos', '11900000007', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000003');
...
select criar_ou_obter_cliente('11111111-1111-1111-1111-111111111111', 'Cliente Cobertura', '11900000008', null, null, null, 'Indicação', 'a1000000-0000-0000-0000-000000000001');
